            ...
            <div class="random-product-container__content">
              ...
              <div class="item-product">
                <div class="item-product__title-product">
                    <a href='{{url("/product/$product->id")}}' class="item-product__title-product__link">{{$product->name}}</a></div>
                <div class="item-product__thumbnail"><a href='{{url("/product/$product->id")}}' class="item-product__thumbnail__link"><img src='{{asset("img/$product->image")}}' alt="Preview-image" class="item-product__thumbnail__link__img"></a></div>
